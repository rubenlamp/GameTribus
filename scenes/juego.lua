...
function Main()
    ...
    function self.load(settings)
        ...
        aldea_list[0] = BotonAldea(love.graphics.newImage("/rcs/img/aldea_cuadrado_normal.png"),1920*0.8,400,500,500)
        aldea_list[1] = BotonAldea(love.graphics.newImage("/rcs/img/aldea_triangulo_normal.png"),500,700,500,500)
        aldea_list[2] = BotonAldea(love.graphics.newImage("/rcs/img/aldea_circulo_normal.png"),400,300,500,500)
